...
{
mzd_t *Wkn = mzd_init(kkk, nnn);
_mzd_add(Wkn, B22, B21);
_mzd_add(Wkn, Wkn, B12);
_mzd_add(Wkn, Wkn, B11);
_mzd_mul_even(C21, A21, Wkn, cutoff);
mzd_free(Wkn);
}
#pragma omp task 
{

_mzd_add(C11, C11, Wmk); /* C21 = C11 - C21 */
_mzd_add(C12, C11, C12); /* C22 = C22 + C11 */
_mzd_add(C11, C21_, C11);
C11_ = mzd_copy(NULL, C11);
...
_mzd_add(C21, C11_, C21); /* C11 = C11 + Wmk */
_mzd_add(C22, C22, C11_); /* C11 = C11 + Wmk */
